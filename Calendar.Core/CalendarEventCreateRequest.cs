...
/// <summary>
/// Describes a calendar event to create.
/// </summary>
public sealed record CalendarEventCreateRequest
{
    ...
    /// <exception cref="ArgumentException">The name is blank, the interval is invalid, or all-day boundaries are not midnight.</exception>
